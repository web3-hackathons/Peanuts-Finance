...
import "@openzeppelin/contracts/token/ERC20/SafeERC20.sol"; // https://forum.openzeppelin.com/t/safeerc20-tokentimelock-wrappers/396/2
...
contract ReaperVault is ERC20, Ownable, ReentrancyGuard {
    using SafeERC20 for IERC20; // make sure the interaction is safe with someone else’s ERC20 token
