import { Typography, PageHeader, Col, Row, Input } from 'antd';
...
function PoolOlPools({ yourLocalBalance, readContracts }) {
    ...
    const ListOlPools = () => {
        ...
        const VaultImages = ({ urls }) => {
            ...
            console.log(props)
            return (<div style={{ width: imgSize, height: imgSize, position: "relative" }}>
                {props.map((obj) => {
                    return (<img width={individualLogoSize} height={individualLogoSize} src={obj.url}
                        style={obj.style}
                    />)
                })}
            </div>)
        ...
        <div>
            <div style={{
                ...
                <Row class="poolHeader">
                    <Col span={12} class="poolHeader__subsection" style={{
                        textAlign: "left"
                    }}>
            ...
            <div style={{
                ...
                <img src="/smugOnlyNoBackHigherGamma.png" style={{
                    height: "100%"
                }} />
            </div>
        </div>
